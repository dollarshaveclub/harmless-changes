...
test('it should not exit if there are harmful changes', () => {
  const changedFilesArray = [0, 1, 2, 3]
  const ciignoreFilesArray = [0, 1, 2, 3]
  checkForHarmfulChanges(changedFilesArray, ciignoreFilesArray)
  expect(1 === 1)
})

// test('it should exit if changedFilesArray is undefined', () => {
//   const ciignoreFilesArray = [0, 1, 2, 3]
//   checkForHarmfulChanges(checkForHarmfulChanges, ciignoreFilesArray)
//   expect(1 === 1)
//   //done.fail(new Error('if changedFilesArray is undefined, it should exit'))
// })
